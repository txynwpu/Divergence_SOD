...
class Pred_endecoder(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.dec1 = Pred_decoder(channel)
        self.dec2 = Pred_decoder(channel)
        self.dec3 = Pred_decoder(channel)
        self.dec4 = Pred_decoder(channel)
        self.dec5 = Pred_decoder(channel)
        self.dec6 = Pred_decoder(channel)
    ...
    def forward(self, x):
        ...
        pred1 = self.dec1(x1,x2,x3,x4)
        pred2 = self.dec2(x1, x2, x3, x4)
        pred3 = self.dec3(x1, x2, x3, x4)
        pred4 = self.dec4(x1, x2, x3, x4)
        pred5 = self.dec5(x1, x2, x3, x4)
        pred6 = self.dec6(x1, x2, x3, x4)
        # pred7 = self.dec7(x1, x2, x3, x4)
        # pred8 = self.dec8(x1, x2, x3, x4)
        # pred9 = self.dec9(x1, x2, x3, x4)
        # pred10 = self.dec10(x1, x2, x3, x4)
